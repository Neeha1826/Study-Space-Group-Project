...
/** Data from the Flask app (including server-side demo); do not overwrite with client-side random simulation. */
...
function updateDataSourcePill() {
  ...
  el.title = tbWarning
    ? tbWarning
    : "Data source: ThingsBoard telemetry merged by Flask at /api/spaces/live; local-only demo if not configured.";
}
